...
| `/top [категорія]` | Топ-10 гравців за статистикою (час, моби, смерті, алмази, блоки) |
| `/sharecoords [X Y Z] <опис>` | Поділитися поточними або вказаними вручну координатами з описом та лінком на 3D-мапу |
| `/report <гравець> <причина>` | Надіслати скаргу на гравця модераторам у Discord |
...
| `/top [категорія]` | Топ-10 гравців сервера (час, вбивства, смерті, алмази, блоки) |
