...
public class DeathTranslator {
    ...
    static {
        ...
        rules.add(new TranslationRule("^(.*?) was shot by (.*?)$", "$2 був застрелений ()$1"));
        rules.add(new TranslationRule("^(.*?) was shot by (.*?) using (.*?)$", "$2 був застрелений ()$1 за допомогою: $3"));
        ...
        rules.add(new TranslationRule("^(.*?) was fireballed by (.*?)$", "$2 був убитий ()$1 вогняною кулею"));
        rules.add(new TranslationRule("^(.*?) was fireballed by (.*?) using (.*?)$", "$2 був убитий ()$1 вогняною кулею за допомогою: $3"));
        ...
        rules.add(new TranslationRule("^(.*?) was killed by (.*?) using magic$", "$2 був убитий ()$1 за допомогою магії"));
        rules.add(new TranslationRule("^(.*?) was killed by (.*?) using (.*?)$", "$2 був убитий ()$1 за допомогою: $3"));
        ...
        rules.add(new TranslationRule("^(.*?) was slain by (.*?)$", "$2 був убитий ()$1"));
        rules.add(new TranslationRule("^(.*?) was slain by (.*?) using (.*?)$", "$2 був убитий ()$1 за допомогою: $3"));
        ...
        rules.add(new TranslationRule("^(.*?) was speared by (.*?)$", "$2 був проштрикнутий ()$1"));
        rules.add(new TranslationRule("^(.*?) was speared by (.*?) using (.*?)$", "$2 був проштрикнутий ()$1 за допомогою: $3"));
        ...
        rules.add(new TranslationRule("^(.*?) was killed by (.*?) while trying to hurt (.*?)$", "$3 був убитий ()$1 під час спроби нашкодити $2"));
        ...
        rules.add(new TranslationRule("^(.*?) was impaled by (.*?)$", "$2 був проткнутий ()$1"));
        rules.add(new TranslationRule("^(.*?) was impaled by (.*?) with (.*?)$", "$2 був проткнутий ()$1 за допомогою: $3"));
