    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("map")) {
            ...
            if (sender instanceof Player) {
                ...
                link.setClickEvent(new net.md_5.bungee.api.chat.ClickEvent(net.md_5.bungee.api.chat.ClickEvent.Action.OPEN_URL, "http://minecord.minecraft.how:27257/"));
                ...
                sender.sendMessage(ChatColor.AQUA + "http://minecord.minecraft.how:27257/");
            }
            return true;
        }
